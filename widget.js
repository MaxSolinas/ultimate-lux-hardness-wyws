(function() {
    ...
    const css = `
        ...
        .kw-lux-slider-wrapper { padding: 14px 20px 18px; transition: opacity 0.3s; margin-top: 10px; }
        .kw-lux-slider-container { position: relative; height: 100px; margin: 0 auto; max-width: 600px; }
        .kw-lux-slider-bar { position: absolute; left: 0; right: 0; bottom: 0; top: auto; width: 100%; height: 55px; display: grid; grid-template-columns: repeat(8, 1fr); border-radius: 6px; overflow: hidden; background: none; box-shadow: none; }
        .kw-lux-scale-segment { position: relative; display: flex; align-items: center; justify-content: center; color: #FFFFFF; font-size: 16px; font-weight: 900; line-height: 1; text-shadow: 0 1px 2px rgba(0,0,0,0.35); font-family: 'Segoe UI', Arial, sans-serif; }
        .kw-lux-scale-segment:not(:last-child)::after { content: ""; position: absolute; top: 0; right: -1px; width: 2px; height: 100%; background: #00384D; z-index: 2; }
        .kw-lux-scale-30 { background: #F28A34; }
        .kw-lux-scale-40 { background: #EB7547; }
        .kw-lux-scale-50 { background: #E94D67; }
        .kw-lux-scale-60 { background: #E22A86; }
        .kw-lux-scale-70 { background: #C43A99; }
        .kw-lux-scale-80 { background: #9557AE; }
        .kw-lux-scale-90 { background: #5C82BF; }
        .kw-lux-scale-100 { background: #3497C8; }
        .kw-lux-grid-lines, .kw-lux-line, .kw-lux-labels { display: none; }
        .kw-lux-water-drop { position: absolute; top: auto; bottom: 52px; width: 26px; height: 34px; background: transparent; transform: translateX(-50%); z-index: 10; transition: left 1.2s cubic-bezier(0.22, 1, 0.36, 1), opacity 0.4s; filter: drop-shadow(0 2px 3px rgba(0,0,0,0.25)); }
        .kw-lux-water-drop::before { content: ""; position: absolute; top: 0; left: 0; width: 26px; height: 26px; background: #2F96C8; border-radius: 50%; }
        .kw-lux-water-drop::after { content: ""; position: absolute; top: 20px; left: 7px; width: 0; height: 0; border-left: 6px solid transparent; border-right: 6px solid transparent; border-top: 10px solid #2F96C8; }
        .kw-lux-drop-shape, .kw-lux-drop-value { display: none; }
        ...
        <div id="wyws-luxembourg-container">
            ...
            <div id="kw-slider-wrapper-lux" class="kw-lux-slider-wrapper">
                <div class="kw-lux-slider-container">
                        ...
                        <div class="kw-lux-scale-segment kw-lux-scale-30">30</div>
                        <div class="kw-lux-scale-segment kw-lux-scale-40">40</div>
                        <div class="kw-lux-scale-segment kw-lux-scale-50">50</div>
                        <div class="kw-lux-scale-segment kw-lux-scale-60">60</div>
                        <div class="kw-lux-scale-segment kw-lux-scale-70">70</div>
                        <div class="kw-lux-scale-segment kw-lux-scale-80">80</div>
                        <div class="kw-lux-scale-segment kw-lux-scale-90">90</div>
                        <div class="kw-lux-scale-segment kw-lux-scale-100">100</div>
                    </div>
